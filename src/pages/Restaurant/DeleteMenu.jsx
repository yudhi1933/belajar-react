  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="bg-red-50 border border-red-200 p-4 rounded-md max-w-md">
        <h2 className="text-xl mb-4">Apakah Anda yakin ingin menghapus menu ini?</h2>
        ...
        <div className="flex gap-2">
          ...
          <button onClick={() => navigate("/restaurant")} className="bg-gray-500 text-white px-4 py-2 rounded">
            Batal
          </button>
        </div>
      </div>
